...
// import com.ssicecreamsshop.utils.ExcelExportUtil; // Export is now in ManageInventoryView
...
public class MainView {
    ...
    public static void show() {
        ...
        // "View Orders" button REMOVED from here

        Region spacer = new Region();
        HBox.setHgrow(spacer, Priority.ALWAYS);

        // HBox topControlsBox = new HBox(15, networkIndicator, viewOrdersButton, spacer, configButton); // Original
        HBox topControlsBox = new HBox(15, networkIndicator, spacer, configButton); // "View Orders" button removed
